...
export const ui = {
  en: {
    ...
    'about.highlight.hackathon.desc': '3rd of 10 teams at the PUCRS Hackathon, and the first team there to use native iOS.',
  ...
  'pt-br': {
    ...
    'about.p2': 'Estudo Engenharia de Software na PUCRS, com formatura em 2027, e desenvolvo na Apple Developer Academy | PUCRS. Três dos meus produtos chegaram à produção antes de eu terminar a graduação.',
    ...
    'about.highlight.hackathon.desc': '3º lugar entre 10 times no Hackathon da PUCRS, e o primeiro time a usar iOS nativo.',
